      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border-2 border-[#2ECC8F]/20">
            ...
            <p className="text-3xl font-bold text-[#2ECC8F]">{ingresosMes.toFixed(2)}â‚¬</p>
          </div>
        </div>
              ...
              return (
                <div key={plan} className="bg-white rounded-2xl p-6 shadow-sm">
                  ...
                  <p className="text-sm font-semibold text-gray-600 mt-2">
                    {(count * PRECIO[plan]).toFixed(2)}â‚¬/mes
                  </p>
                </div>
              );
            })}
        ...
        {tab === "fichajes" && (
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-2">
              ...
              <h3 className="font-bold text-[#1B2E4B]">Ãšltimos 100 fichajes</h3>
            </div>
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  ...
                  <th className="text-left px-6 py-4 text-gray-500 font-medium">UbicaciÃ³n</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-50">
                {fichajes.map((f) => (
                    ...
                    <td className="px-6 py-4">
                      {f.dentro ? (
                        <span className="flex items-center gap-1 text-[#2ECC8F] text-xs">
                          <CheckCircle size={12} /> En ubicaciÃ³n
                        </span>
                      ) : (
